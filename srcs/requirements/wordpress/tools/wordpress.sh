...
wp-cli user create $WP_USER $WP_USER_EMAIL --user_pass=$WP_USER_PASSWORD --role=editor --allow-root --path=/var/www/html/wordpress
wp-cli post create --post_type=post --post_title='Hello world' --post_content='Welcome to my blog!' --post_status=publish --path=/var/www/html/wordpress --allow-root
echo "\
